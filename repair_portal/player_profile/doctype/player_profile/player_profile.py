...
# Dependencies: Customer, Instrument Profile, Repair Log, Instrument Inspection, Setup Log, Leak Test, etc.
    ...
    def on_update(self):
        try:
            ...
            for table_field, doctype, filters, src_fields, tgt_fields in mappings:
                ...
                for r in rows:
                    self.append(table_field, dict(zip(tgt_fields, [r[f] for f in src_fields], strict=False)))
        except Exception:
