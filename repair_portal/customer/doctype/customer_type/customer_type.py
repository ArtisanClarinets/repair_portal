...
class CustomerType(Document):
    ...
    def _validate_deletion_allowed(self) -> None:
        ...
        if customers_using:
            ...
            frappe.throw(_(
                "Cannot delete Customer Type. It is being used by customers: {0}"
            ).format(", ".join(customer_names)))
    ...
    def get_default_customer_type() -> str | None:
        ...
        default_type = frappe.db.get_value("Customer Type", 
    ...
    def get_active_customer_types() -> list[dict]:
        ...
        return frappe.db.get_list("Customer Type",
            filters={"disabled": 0},
