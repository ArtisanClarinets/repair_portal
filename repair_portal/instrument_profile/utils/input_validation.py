...
ALLOWED_HTML_ATTRIBUTES = {"*": ["class", "style"], "a": ["href", "title"], "div": ["id"], "span": ["id"]}
...
class InputValidator:
    ...
    def _validate_html(self, field_name: str, value: Any, config: Dict[str, Any]) -> str:
        ...
        sanitized_value = bleach.clean(value, tags=allowed_tags, attributes=allowed_attributes, strip=True)
    ...
    def _validate_link(self, field_name: str, value: Any, config: Dict[str, Any]) -> str:
        ...
        if not frappe.has_permission(target_doctype, "read", value):
            raise ValidationError(
                f"Field '{field_name}' insufficient permissions for {target_doctype}: {value}"
            )
    ...
    def _log_validation_violation(self, field_name: str, field_value: Any, error_message: str):
        ...
        try:
            log_data = {
                ...
                "user_agent": (
                    frappe.local.request.headers.get("User-Agent", "unknown")
...
def validate_instrument_profile_data(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    schema = {
        ...
        "instrument_model": {"type": "link", "target_doctype": "Instrument Model", "required": True},
        ...
        "notes": {"type": "html", "required": False, "max_length": 5000},
    }
...
def validate_customer_external_work_log_data(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    schema = {
        "instrument_profile": {"type": "link", "target_doctype": "Instrument Profile", "required": True},
        "work_type": {
            "type": "select",
        ...
        "work_date": {"type": "date", "required": True, "max_date": "today"},
        "cost": {"type": "number", "min_value": 0, "max_value": 10000},
        "description": {"type": "html", "required": False, "max_length": 2000},
    }
...
def validate_client_instrument_profile_data(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    schema = {
        "instrument_profile": {"type": "link", "target_doctype": "Instrument Profile", "required": True},
        "customer": {"type": "link", "target_doctype": "Customer", "required": True},
        "preferred_service_schedule": {
            "type": "select",
            "options": ["Monthly", "Quarterly", "Semi-Annual", "Annual", "As Needed"],
            "required": False,
        },
        "special_instructions": {"type": "html", "required": False, "max_length": 3000},
        "contact_preference": {
            "type": "select",
