...
class ClientInstrumentProfile(Document):
    ...
    def _get_validation_schema(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            'serial_no': {
                'type': 'link',
                'target_doctype': 'Instrument Serial Number',
                'required': True
            },
            'instrument_model': {
                'type': 'string',
    ...
    def _validate_file(self, file_url: str, field_name: str):
        ...
        try:
            ...
            if file_doc.file_size and file_doc.file_size > (MAX_FILE_SIZE_MB * 1024 * 1024):
                raise ValidationError(
                    f"File size for {field_name} exceeds {MAX_FILE_SIZE_MB}MB limit"
                )
    ...
    def _log_field_changes(self):
        ...
        significant_fields = [
            'instrument_owner', 'verification_status', 'ownership_transfer_to',
            'instrument_category', 'instrument_model'
        ]
    ...
    def _create_or_update_instrument_profile(self):
        ...
        try:
            ...
            frappe.log_error(
                ...
                'Client Instrument Profile: Failed to create Instrument Profile'
            )
