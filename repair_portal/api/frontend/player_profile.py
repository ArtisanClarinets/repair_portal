...
def save():
    ...
    for field in [
        'player_name', 'preferred_name', 'primary_email', 'primary_phone', 'mailing_address',
        'profile_creation_date', 'profile_status', 'player_level',
        'affiliation', 'primary_teacher', 'key_height_preference', 'spring_tension_preference',
        'preferred_pad_type', 'g_sharp_a_connection', 'intonation_notes',
        'last_visit_date', 'customer_lifetime_value', 'communication_preference',
        'newsletter_subscription', 'referral_source'
    ]:
        if field in data:
