...
def execute(filters=None):
    ...
    columns = [
        {"label": "Inspection Type", "fieldname": "inspection_type", "fieldtype": "Data", "width": 120},
        {"label": "Total Inspections", "fieldname": "total", "fieldtype": "Int", "width": 120},
        {"label": "First Pass Yield (%)", "fieldname": "first_pass_yield", "fieldtype": "Percent", "width": 150},
        {"label": "Average ΔP (psi)", "fieldname": "avg_dp", "fieldtype": "Float", "width": 120},
        {"label": "Avg Spring Spread (g)", "fieldname": "avg_spring_spread", "fieldtype": "Float", "width": 150},
        {"label": "Re-service Rate (%)", "fieldname": "re_service_rate", "fieldtype": "Percent", "width": 150}
    ]
    return columns, [row]
