...
class RepairPortalVerification:
    ...
    def verify_console_cleanup(self):
        ...
        try:
            ...
            if remaining_count <= 10:  # Allow minimal console statements
                ...
                self.results["failed"].append(f"❌ Console cleanup: {remaining_count} statements remain")
    ...
    def verify_controller_enhancements(self):
        ...
        controller_path = f"{self.app_path}/repair_logging/doctype/repair_parts_used/repair_parts_used.py"
        ...
        try:
            ...
            if "Validation failed" not in result.stdout:
                ...
                if error_count <= 10:  # Allow some non-critical issues
                    self.results["warnings"].append(f"⚠️ Frappe v15 compliance: {error_count} minor issues")
    ...
    def verify_security_implementations(self):
        ...
        if os.path.exists(security_path):
            ...
            if implemented_features >= 4:
                ...
                self.results["failed"].append(f"❌ API Security: Only {implemented_features}/5 features")
    ...
    def verify_performance_optimizations(self):
        ...
        if os.path.exists(optimizer_path):
            ...
            implemented_optimizations = sum(1 for feature in optimization_features if feature in content)
            ...
            if implemented_optimizations >= 4:
                ...
                self.results["warnings"].append(f"⚠️ Performance: {implemented_optimizations}/5 optimizations")
    ...
    def verify_error_handling(self):
        ...
        if os.path.exists(error_handler_path):
            ...
            if implemented_features >= 4:
                ...
                self.results["warnings"].append(f"⚠️ Error Handling: {implemented_features}/5 features")
    ...
    def print_summary(self):
        ...
        total_checks = (
            len(self.results["passed"]) + len(self.results["failed"]) + len(self.results["warnings"])
        )
