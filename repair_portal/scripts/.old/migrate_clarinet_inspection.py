# repair_portal/inspection/doctype/inspection_report/migrate_clarinet_inspection.py
...
def migrate_all_clarinet_inspections():
    ...
    # Save mapping to CSV
    with open(
        "/opt/frappe/erp-bench/apps/repair_portal/clarinet_inspection_migration_map.csv",
        "w",
        newline="",
    ) as csvfile:
