// Recording Analyzer Desk Page - Frappe v15 compatible
// Last Updated: 2025-07-24
// Purpose: UI for collecting audio and running lab analysis via Lab API

frappe.pages['recording_analyzer'].on_page_load = function(wrapper) {
  let audioBlob = null;
  let intonationChart = null, toneChart = null, leakChart = null, impChart = null;

  const makeAudioTools = () => {
    const $wrapper = $('<div style="margin: 20px"></div>').appendTo(wrapper);
