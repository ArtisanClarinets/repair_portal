			...
			<section v-if="submissionState.success" class="submission-summary" aria-live="polite">
				...
				<ul>
					...
					<li v-if="submissionState.links.intake_receipt_print">
						<a
							:href="submissionState.links.intake_receipt_print"
							target="_blank"
					...
					<li v-if="submissionState.links.instrument_tag_print">
						<a
							:href="submissionState.links.instrument_tag_print"
							target="_blank"
							rel="noopener noreferrer"
					...
					<li v-if="submissionState.links.instrument_qr_print">
						<a
							:href="submissionState.links.instrument_qr_print"
							target="_blank"
							rel="noopener noreferrer"
...
function openKnowledgeBase() {
	window.open(
		"https://artisanclarinets.notion.site/intake-sop",
		"_blank",
		"noopener,noreferrer",
	);
}
