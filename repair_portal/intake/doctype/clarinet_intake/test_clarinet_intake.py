...
class TestClarinetIntake(FrappeTestCase):
        ...
        intake = frappe.get_doc(
            {
                ...
                "customer": frappe.db.get_value(
                    "Customer", {"customer_name": "Test Customer Repair"}, "name"
                ),
    ...
    def test_idempotent_record_creation(self):
        ...
        self.assertEqual(
            initial_instrument_count, final_instrument_count, "Should not create duplicate Instrument"
        )
