...
def execute(filters=None):
    columns = [
        ...
        {"fieldname": "issued_to", "label": "Customer", "fieldtype": "Link", "options": "Customer", "width": 200},
        {"fieldname": "issued_date", "label": "Issued Date", "fieldtype": "Date", "width": 120},
        {"fieldname": "expected_return_date", "label": "Expected Return", "fieldtype": "Date", "width": 120},
