...
def execute(filters=None):
    columns = [
        {"fieldname": "appointment_date", "label": "Appointment Date", "fieldtype": "Datetime", "width": 180},
        {"fieldname": "customer", "label": "Customer", "fieldtype": "Link", "options": "Customer", "width": 180},
        {"fieldname": "serial_number", "label": "Instrument Serial", "fieldtype": "Data", "width": 140},
