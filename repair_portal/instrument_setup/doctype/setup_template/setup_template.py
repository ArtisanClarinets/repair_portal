...
class SetupTemplate(Document):
    ...
    if TYPE_CHECKING:
        ...
        from repair_portal.instrument_setup.doctype.clarinet_template_task.clarinet_template_task import ClarinetTemplateTask
        ...
        setup_type: DF.Literal["Standard Setup", "Advanced Setup", "Repair & Setup", "Maintenance", "Overhaul", "Custom Setup"]
