...
class TestInstrumentSetup(unittest.TestCase):
    ...
    def test_clarinet_pad_map_creation(self):
        ...
        pad_map.append(
            "top_joint_pads",
            {"pad_position": "G#", "pad_size": "9.5mm", "material_type": "Leather", "is_open_key": 1},
        )
        pad_map.append(
            "bottom_joint_pads",
            {"pad_position": "Low E", "pad_size": "14mm", "material_type": "Synthetic", "is_open_key": 0},
        )
        pad_map.save()
    ...
    def test_material_logging(self):
        ...
        setup.append(
            "materials_used",
            {"material_type": "Pad", "quantity": 5, "cost": 25.0, "notes": "Replacement pads for tone holes"},
        )
        setup.save()
...
def make_test_records_for_instrument_setup():
    ...
    records = [
        # Instrument Category
        {"doctype": "Instrument Category", "title": "Woodwind", "description": "Woodwind instruments"},
        # Instrument Model
        {
