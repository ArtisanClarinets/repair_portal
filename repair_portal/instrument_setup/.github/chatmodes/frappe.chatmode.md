...
tools: ['runCommands', 'runTasks', 'createFile', 'createDirectory', 'editFiles', 'search', 'runVscodeCommand', 'getProjectSetupInfo', 'extensions', 'todos', 'runTests', 'usages', 'think', 'problems', 'changes', 'testFailure', 'fetch', 'sequentialthinking', 'memory']
---
