...
def create_a_clarinet_standard_template():
    ...
    try:
        ...
        template = frappe.get_doc({
            ...
            "checklist_items": [
                # Part I
                {"task": "Perform Environmental Logging & Acclimatization", "notes": "Allow case to acclimate for a minimum of 4 hours at 45-55% RH before opening."},
                {"task": "Complete Visual and Tactile Inspection", "notes": "Inspect wood for fractures, check keywork integrity, and document initial pad/cork condition. Upload photos."},
                {"task": "Assess Initial Tenon Fit (Dry Fit)", "notes": "Assemble without grease. Categorize each tenon fit as 'Loose', 'Snug (Ideal)', or 'Tight' and log."},
                {"task": "Execute Standardized Break-In Schedule", "notes": "Log 14 consecutive days of 20-30 minute play sessions, swabbing thoroughly after each."},
                {"task": "Perform Bore Oiling", "notes": "After the break-in period, apply a light coat of high-quality bore oil, taking care to avoid all pads."},
                # Part II
                {"task": "Verify Tone Hole Geometry", "notes": "Use precision tools to inspect tone hole rims, undercutting, and surface finish. Correct any imperfections."},
                ...
                # Part III
                {"task": "Select and Install All Pads", "notes": "Choose appropriate pads (Leather/Synthetic/Cork). 'Float' pads to be perfectly parallel with tone holes and verify the seal with a feeler gauge."},
                {"task": "Optimize Key Heights ('Venting')", "notes": "Measure all key opening heights and adjust key foot corks to match the target specifications for an A clarinet."},
                {"task": "Calibrate Spring Tensions", "notes": "Use a gram tension gauge to measure and adjust all spring tensions to the pre-defined specs for an A clarinet."},
                ...
                {"task": "Generate Empirical Pitch Curve", "notes": "Map the instrument's intonation tendencies across its full range using a high-precision tuner."},
            ...
            "operations_performed": [
                ...
                {"doctype": "Clarinet Setup Operation", "operation_type": "Tenon Fitting", "section": "Lower Joint", "component_ref": "All Tenons", "details": "1. Gently assemble the instrument without cork grease.\n2. Assess the raw fit, noting any wobble or excessive tightness.\n3. Categorize and log each tenon fit as 'Loose,' 'Snug (Ideal),' or 'Tight'."},
