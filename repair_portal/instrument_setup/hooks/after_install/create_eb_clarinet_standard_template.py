...
def create_eb_clarinet_standard_template():
    ...
    try:
        ...
        template = frappe.get_doc(
            {
                ...
                'checklist_items': [
                    # Part I
                    {
                        ...
                        'notes': 'Case must acclimate for a minimum of 4 hours at 45-55% RH before opening.',
                    },
                    {
                        'task': 'Complete Visual and Tactile Inspection',
                        'notes': 'Inspect wood for any fractures and keywork for integrity. Document initial pad/cork condition and upload photos.',
                    },
                    {
                        'task': 'Assess Initial Tenon Fit (Dry Fit)',
                        'notes': "Assemble without any grease. Categorize each tenon fit ('Loose', 'Snug (Ideal)', 'Tight') and log the assessment.",
                    },
                    {
                        'task': 'Execute Standardized Break-In Schedule',
                        'notes': 'Log 14 consecutive days of 20-30 minute play sessions, ensuring to swab thoroughly after each use.',
                    },
                    {
                        'task': 'Perform Bore Oiling',
                        'notes': 'After the break-in period, apply a light coat of high-quality bore oil, taking extreme care to avoid all pads.',
                    },
                    # Part II
                    {
                        'task': 'Verify Tone Hole Geometry',
                        'notes': 'Use precision tools to inspect tone hole rims, undercutting, and surface finish. Correct any and all imperfections found.',
                    },
                    {
                    ...
                    # Part III
                    {
                        ...
                        'notes': "Choose appropriate pads (Leather/Synthetic/Cork). 'Float' pads until perfectly parallel with tone holes and verify the seal using a feeler gauge.",
                    },
                    {
                        'task': "Optimize Key Heights ('Venting')",
                        'notes': 'Measure all key opening heights and adjust key foot corks to match the target specifications for an E♭ clarinet.',
                    },
                    {
                        'task': 'Calibrate Spring Tensions',
                        'notes': 'Use a gram tension gauge to measure and adjust all spring tensions to the pre-defined specs for an E♭ clarinet.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        'notes': "Map the instrument's intonation tendencies across its full range using a high-precision tuner and a reference setup.",
                    },
                    {
                ...
                'operations_performed': [
                    ...
                    },
                    {
                        ...
                        'details': "1. Gently assemble the instrument without cork grease to assess the raw fit.\n2. Categorize and log each tenon fit as 'Loose,' 'Snug (Ideal),' or 'Tight'.",
                    },
                    {
                        'doctype': 'Clarinet Setup Operation',
                        'operation_type': 'Setup',
        ...
        frappe.log_error(
            frappe.get_traceback(), 'E♭ Clarinet Standard Setup Template Creation Failed'
        )
        frappe.db.rollback()
