...
def execute(filters=None):
    ...
    data = frappe.get_all(
        "Repair Order",
        fields=["customer", "issue_description", "status", "technician_assigned", "priority_level", "promise_date"],
    ...
    columns = [
        ...
        {"label": "Technician", "fieldname": "technician_assigned", "fieldtype": "Link", "options": "User", "width": 120},
