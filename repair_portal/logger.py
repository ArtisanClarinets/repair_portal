...
def exception_to_logs(msg: str, *args, suffix: str | None = None, **kwargs) -> None:
	"""
...
def audit(msg: str, *args, suffix: str | None = None, **kwargs) -> None:
	"""
...
def error(msg: str, *args, suffix: str | None = None, **kwargs) -> None:
	"""Shorthand for ERROR logs."""
	get_logger(suffix).error(msg, *args, **kwargs)


def warn(msg: str, *args, suffix: str | None = None, **kwargs) -> None:
	"""Shorthand for WARNING logs."""
	get_logger(suffix).warning(msg, *args, **kwargs)


def info(msg: str, *args, suffix: str | None = None, **kwargs) -> None:
...
def log_exceptions(suffix: str | None = None, reraise: bool = False):
	"""
